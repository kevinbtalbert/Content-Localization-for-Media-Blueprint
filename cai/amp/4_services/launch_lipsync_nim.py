#!/usr/bin/env python3
"""CAI application entry: LipSync NIM."""
...
def main() -> int:
    if is_serverless_nim_mode():
        return run_serverless_nim_placeholder("lipsync-nim-serverless")
    return run_bash_script("cai/amp/4_services/launch_lipsync_nim.sh")
