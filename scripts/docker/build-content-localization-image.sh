...
#
# Optional:
#   CONTENT_LOCALIZATION_VERSION=1.2.0
#   CONTENT_LOCALIZATION_REPO=content-localization
#   CONTENT_LOCALIZATION_REGISTRY=docker.io/you/content-localization   # also tags registry copy
...
#   content-localization:1.2.0-turing
#   content-localization:latest
#   (+ registry tags when CONTENT_LOCALIZATION_REGISTRY is set)
#
...
VERSION="${CONTENT_LOCALIZATION_VERSION:-1.2.0}"
