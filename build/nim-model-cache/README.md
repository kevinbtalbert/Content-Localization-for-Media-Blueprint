...
| `CONTENT_LOCALIZATION_IMAGE` | No | `content-localization:1.8.0-turing` | Override auto-tagging (disables arch suffix) |
...
# → content-localization:1.8.0-turing (+ registry tag when set)
```
...
docker build --platform linux/amd64 -t content-localization:1.8.0-turing .
```
...
|--------------|--------------|----------------------|
| **Turing** | T4, RTX 20xx | `:1.8.0-turing` |
| **Ampere** | A2, A10, A16, A40, L4 | `:1.8.0-ampere` |
| **Ada** | L40, L40S, RTX 4090 | `:1.8.0-ada` |
| **Blackwell** | B40, RTX 5080/5090 | `:1.8.0-blackwell` |
